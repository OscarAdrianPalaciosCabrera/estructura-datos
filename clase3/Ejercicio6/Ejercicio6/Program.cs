        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                for (int i = 0; i < emplea; i++)
                {
                    ...
                    Console.WriteLine("Indique su sexo hombre, mujer");
                    ...
                    switch (sexo)
                    {
                        case ("hombre"):
                            ...
                            Console.WriteLine("");
                            Console.WriteLine("Digite su estado civil (1:soltero, 2:casado, 3:viudo)");
                            ...
                            switch (Estaciv)
                            {
                                case 1:
                                    Console.WriteLine("");
                                    Console.WriteLine("Digite su salario (1:menos de 600 Bs.F., 2:entre 600 y 1000Bs.F., 3:Mas de 1000Bs)");
                        ...
                        case ("mujer"):
                            ...
                            Console.WriteLine("");
                            Console.WriteLine("Digite su estado civil (1:soltera, 2:casada, 3:viuda)");
                            Estaciv = Convert.ToInt16(Console.ReadLine());
                            Console.WriteLine("");
                            switch (Estaciv)
                            {
